...
public class ArmorScript : MonoBehaviour {
    ...
    void OnMouseUp()
    {
        ...
        if (hit)
        {
            ...
            else if (hitInfo.transform.tag == "Armor")
            {
                //print(InventoryScript.wornArmorCnt());
                int index = getEmptyArmorSlot();
    ...
    int getEmptyArmorSlot()
    {
        if (InventoryScript.getEquippedArmorList()[0] == "") { return 0; }
        else if (InventoryScript.getEquippedArmorList()[1] == "") { return 1; }
        else if (InventoryScript.getEquippedArmorList()[2] == "") { return 2; }
        else return 3;
    }
}
